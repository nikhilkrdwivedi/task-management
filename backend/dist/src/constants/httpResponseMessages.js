...
const httpResponseMessages = {
    ...
    INVALID_PASSWORD_ERROR: "Please send a valid password, must contains one uppercase, one lowercase, one number, one special character and length will be between 8-30 characters!",
    USER_ALREADY_EXIST: "Hey, are you sure you haven't used this email before. Please login!",
    USER_CREATED: "User successfully created!",
    EMAIL_REQUIRED: "Email is required!",
    NAME_REQUIRED: "Name is required!",
    PASSWORD_REQUIRED: "Password is required!",
};
exports.default = httpResponseMessages;
